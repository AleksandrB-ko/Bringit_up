    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMessage.textContent = _this2.message.loading;
          var formData = new FormData(item);

          _this2.postData(_this2.path, formData).then(function (res) {
            console.log(res);
            statusMessage.textContent = _this2.message.success;
          }).catch(function () {
            statusMessage.textContent = _this2.message.failure;
          }).finally(function () {
            _this2.clearInputs();
